...
export default function BirthdayLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Fredoka+One&family=Nunito:wght@400;600;700;800;900&family=Dancing+Script:wght@600;700&family=Playfair+Display:ital@0;1&display=swap"
        rel="stylesheet"
      />
